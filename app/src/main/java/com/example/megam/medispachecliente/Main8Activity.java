...
import com.example.megam.medispachecliente.fragments.LancheFragment;
...
public class Main8Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user==null){
            ...
            LancheFragment fragobj = new LancheFragment();
            fragobj.setArguments(bundle);
            getSupportFragmentManager().beginTransaction().replace(R.id.containerC8, fragobj)
                    .commit();
